...
Subject.create(name: 'CSS', desc: 'CSS stands for Cascading Style Sheets. CSS describes how HTML elements are displayed on screen, paper, or in other media.', img:'css.jpg')
